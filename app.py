...
def matching():
    ...
    if form.validate_on_submit()and form.submit.data:
        ...
        for i in sChar:
            ...
            words=space.join(words)
        words=words.split()
        sl1= ["analyse","analysed","analyser","analysers","analyses","analysing","analysis","analyst","analysts","analytic","analytical","analytically","analyze","analyzed","analyses","analyzing",
        "approach","approachable","approached","approaches","approaching","unapproachable",
        "area","areas","assess","assessable","assessed","assesses","assessing","assessment","assessments","reassess","reassessed","reassessing","reassessment","unassessed",
        "assume","assumed","assumes","assuming","assumption","assumptions","authority","authoritative","authorities","available","availability","unavailable",
        "benefit","beneficial","beneficiary","beneficiaries","benefited","benefiting","benefits","concept","conception","concepts","conceptual","conceptualisation","conceptualise","conceptualised","conceptualises","conceptualising","conceptually",
        "consist","consisted","consistency","consistent","consistently","consisting","consists","inconsistencies","inconsistency","inconsistent","constitute","constituencies","constituency","constituent","constituents","constituted","constitutes","constituting","constitution","constitutions","constitutional","constitutionally","constitutive","unconstitutional",
        ...
        "contract","contracted","contracting","contractor","contractors","contracts","create","created","creates","creating","creation","creations",
        "creative","creatively","creativity","creator","creators","recreate","recreated","recreates","recreating","data",
        "define","definable","defined","defines","defining","definition","definitions","redefine","redefined","redefines","redefining","undefined",
        "derive","derivation","derivations","derivative","derivatives","derived","derives","deriving","distribute","distributed","distributing","distribution","distributional","distributions","distributive","distributor","distributors",
        "redistribute","redistributed","redistributes","redistributing","redistribution","economy","economic","economical","economically","economics","economies","economist","economists","uneconomical",
        ...
        "estimate","estimated","estimates","estimating","estimation","estimations","overestimate","overestimate","overestimated","overestimates","overestimating","underestimate","underestimated","underestimates","underestimating",
        "evident","evidenced","evidence","evidential","evidently","export","exported","exporter","exporters","exporting","exports",
        "factor","factored","factoring","factors","finance","financed","finances","financial","financially","financier","financiers","financing",
        ...
        "function","functional","functionally","functioned","functioning","functions","identify","identifiable","identification","identified","identifies","identifying","identities","identity","unidentifiable",
        "income","incomes","indicate","indicated","indicates","indicating","indication","indications","indicative","indicator","indicators",
        ...
        "interpret","interpretation","interpretations","interpretative","interpreted","interpreting","interpretive","interprets",
        "misinterpret","misinterpretation","misinterpretations","misinterpreted","misinterpreting","misinterprets","reinterpret","reinterpreted","reinterprets","reinterpreting","reinterpretation","reinterpretations",
        "involve","involved","involvement","involves","involving","uninvolved","issue","issued","issues","issuing",
        "labour","labor","labored","labors","laboured","labouring","labours","legal","illegal","illegality","illegally","legality","legally",
        "legislate","legislated","legislates","legislating","legislation","legislative","legislator","legislators","legislature","major","majorities","majority",
        "method","methodical","methodological","methodologies","methodology","methods","occur","occurred","occurrence","occurrences","occurring","occurs","reoccur","reoccurred","reoccurring","reoccurs",
        "percent","percentage","percentages","period","periodic","periodical","periodically","periodicals","periods",
        "policy","policies","principle","principled","principles","unprincipled","proceed","procedural","procedure","procedures","proceeded","proceeding","proceedings","proceeds",
        "process","processed","processes","processing","require","required","requirement","requirements","requires","requiring","research","researched","researcher","researchers","researches","researching",
        "respond","responded","respondent","respondents","responding","responds","response","responses","responsive","responsiveness","unresponsive",
        "role","roles","section","sectioned","sectioning","sections","sector","sectors","significant","insignificant","insignificantly","significance","significantly","signified","signifies","signify","signifying",
        "similar","dissimilar","similarities","similarity","similarl","source","sourced","sources","sourcing","specific","specifically","specification","specifications","specificity","specifics",
        ...
        "theory","theoretical","theoretically","theories","theorist","theorists","vary","invariable","invariably","variability","variable","variables","variably","variance","variant","variants","variation","variations","varied","varies","varying"]
